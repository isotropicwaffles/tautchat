...
/**
 * Group object which can be composed of an arbitrary number of Users.  Groups can also have/be
 * subgroups.
 *
 * @author jdwilson73
 */
public class Group {
  ...
  /**
   * Whether or not the group is still active. If Group is deactivated, no changes can be made to
   * Group's fields.  Additionally, Group will be invisible in all searches by Users who are not
   * moderators of the Group.  Also no messages may be routed to/from the deactivated Group. If
   * Group was deactivated while serving as a sub/supergroup of another Group, that status will not
   * be retained--i.e. the Group will have to re-merge manually.
   */
  private boolean isActive;

  /**
   * Set of Users serving as moderators for this Group. Every Group must have at least one
   * moderator.
   */
  ...
  /**
   * Tracks the current alias of each User in the Group. An alias is the specific name used by a
   * User in the given Group.
   */
  private Map<User, String> memberAliases;

  /**
   * Contains Users who have attempted to join the Group but who have not yet been approved by a
   * moderator.
   */
  private Set<User> joinUserQueue;

  /**
   * Contains Groups who have attempted to join the Group but who have not yet been approved by a
   * moderator.
   */
  ...
  /**
   * Determines whether or not the given User is a member of this Group.
   *
  ...
  /**
   * If executed by a moderator, Group is deactivated. I.e. The Group may no longer have its fields
   * changed and will not be visible to general Users.
   *
   * @param mod the executing moderator
   */
  ...
  /**
   * If executed by a moderator, Group is reactivated. I.e. The Group may once again have its fields
   * changed and be visible to general Users.
   *
   * @param mod the executing moderator
   */
  ...
  /**
   * Adds given Group to this Group's set of subgroups. By extension, also adds this group to given
   * Group's set of supergroups.
   *
   * @param mod      the executing moderator
  ...
  /**
   * Removes given Group from this Group's set of subgroups. By extension, also removes this group
   * from given Group's set of supergroups.
   *
   * @param mod      the executing moderator
  ...
  /**
   * Adds given Group to this Group's set of supergroups. By extension, also adds this group to
   * given Group's set of subgroups.
   *
   * @param mod        the executing moderator
  ...
  /**
   * Removes given Group from this Group's set of supergroups. By extension, also removes this group
   * from given Group's set of subgroups.
   *
   * @param mod        the executing moderator
  ...
  public void removeUser(User mod, User user) {
    ...
    if (mod.equals(user) || authenticateAsMod(mod, this)) {
      ...
      } else this.joinUserQueue.remove(user);
